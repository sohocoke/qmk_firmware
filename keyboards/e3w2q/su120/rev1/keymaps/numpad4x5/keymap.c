...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(  /* upper layer */
    KC_F10,   KC_F11,   KC_F12,   KC_NLCK,   KC_BSPC,  _______,  _______,  _______,  _______,  _______,  
    LGUI(KC_B), _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  
    LGUI(KC_X), LGUI(KC_C), LGUI(KC_V),  _______,  _______,  _______,  _______,  _______,  _______,  _______,  
    _______,  SEND_00,  _______,  _______,  KC_SPC,  _______,  _______,  _______,  _______,  _______,  
